...
public class HoneyBrickContainer : MonoBehaviour
{
    [SerializeField] private List<HoneyBrickPlace> _honeyBrickPlaces;
    ...
    private void OnEnable()
    {
        ...
        {
            _honeyBrickPlaces.Add(transform.GetChild(i).GetComponent<HoneyBrickPlace>());
    ...
    private void OnBrickTaken(HoneyBrickPlace position)
    {
        _currentBricksAmount--;
        BrickAmountChanged?.Invoke(_currentBricksAmount, _maxBricksAmount);
    }
